import{_ as a,o as n,c as e,a as l}from"./app-5QVbWi7Z.js";const i={};function p(c,s){return n(),e("div",null,s[0]||(s[0]=[l(`<h1 id="国际化" tabindex="-1"><a class="header-anchor" href="#国际化"><span>国际化</span></a></h1><p>友情提示：</p><p>该章节，基于 <a href="https://kailong110120130.gitee.io/vue-element-plus-admin-doc/dep/i18n.html" target="_blank" rel="noopener noreferrer">《vue element plus admin —— 国际化》</a> 的内容修改。</p><p>如果你使用的 vscode 开发工具，则推荐安装 <a href="https://marketplace.visualstudio.com/items?itemName=Lokalise.i18n-ally" target="_blank" rel="noopener noreferrer">I18n-ally</a> 这个插件</p><h2 id="_1-i18n-ally-插件" tabindex="-1"><a class="header-anchor" href="#_1-i18n-ally-插件"><span><a href="#_1-i18n-ally-%E6%8F%92%E4%BB%B6">#</a> 1. I18n-ally 插件</span></a></h2><p>安装了该插件后，你的代码内可以实时看到对应的语言内容</p><figure><img src="https://kailong110120130.gitee.io/vue-element-plus-admin-doc/images/i18n.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="_2-配置默认语言" tabindex="-1"><a class="header-anchor" href="#_2-配置默认语言"><span><a href="#_2-%E9%85%8D%E7%BD%AE%E9%BB%98%E8%AE%A4%E8%AF%AD%E8%A8%80">#</a> 2. 配置默认语言</span></a></h2><p>在 <a href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/store/modules/locale.ts" target="_blank" rel="noopener noreferrer">src/store/modules/locale.ts</a> 内配置 <code>currentLocale</code> 为其他语言。</p><p>查看代码</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#abb2bf;--shiki-dark:#abb2bf;--shiki-light-bg:#282c34;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code"><code><span class="line"><span>import { defineStore } from &#39;pinia&#39;</span></span>
...
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_8-1-uselocale" tabindex="-1"><a class="header-anchor" href="#_8-1-uselocale"><span><a href="#_8-1-uselocale">#</a> 8.1 useLocale</span></a></h3><p>代码: <a href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/hooks/web/useLocale.ts#L19-L35" target="_blank" rel="noopener noreferrer">src/hooks/web/useLocale.ts</a></p><p>当手动切换语言的时候会触发 <code>useLocale</code> 函数，useLocale 也是异步函数，只需等待接口返回响应的数据后，再进行设置即可</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#abb2bf;--shiki-dark:#abb2bf;--shiki-light-bg:#282c34;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code"><code><span class="line"><span>export const useLocale = () =&gt; {</span></span>
