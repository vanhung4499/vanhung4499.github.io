import{_ as e,g as p,o as i,c as l,e as t,h as s,f as r,w as c,a}from"./app-BRTHG7K9.js";const d={},o=a('<h1 id="mybatis-联表-分页查询" tabindex="-1"><a class="header-anchor" href="#mybatis-联表-分页查询"><span>MyBatis 联表&amp;分页查询</span></a></h1><p>本文，分享 MyBatis 各种常用操作，不限于链表查询、分页查询等等。</p><h2 id="_1-分页查询" tabindex="-1"><a class="header-anchor" href="#_1-分页查询"><span><a href="#_1-%E5%88%86%E9%A1%B5%E6%9F%A5%E8%AF%A2">#</a> 1. 分页查询</span></a></h2>',3),m=a(`<p>这里，以查询 <code>system_users</code> 表为例，讲解如何使用 XML 实现分页查询。</p><h3 id="_1-1-方案一-mybatis-xml" tabindex="-1"><a class="header-anchor" href="#_1-1-方案一-mybatis-xml"><span><a href="#_1-1-%E6%96%B9%E6%A1%88%E4%B8%80-mybatis-xml">#</a> 1.1 方案一：MyBatis XML</span></a></h3><p>这个是 MyBatis 内置的使用方式，步骤如下：</p><figure><img src="https://doc.iocoder.cn/img/数据库MyBatis/分页案例01/01.png" alt="分页案例 01" tabindex="0" loading="lazy"><figcaption>分页案例 01</figcaption></figure><p>① 创建 <code>AdminUserMapper.xml</code> 文件，编写两个 SQL 查询语句：</p><div class="language- line-numbers-mode" data-ext="" data-title=""><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code" style="background-color:#282c34;--shiki-dark-bg:#282c34;color:#abb2bf;--shiki-dark:#abb2bf;" tabindex="0"><code><span class="line"><span>&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;</span></span>
...
<span class="line"><span>        );</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>④ 简单调用下，可以在 IDEA 控制台看到 2 条 SQL：</p><figure><img src="https://doc.iocoder.cn/img/数据库MyBatis/分页案例01/02.png" alt="分页案例 01 的效果" tabindex="0" loading="lazy"><figcaption>分页案例 01 的效果</figcaption></figure><h3 id="_1-2-方案二-mybatis-plus-xml" tabindex="-1"><a class="header-anchor" href="#_1-2-方案二-mybatis-plus-xml"><span><a href="#_1-2-%E6%96%B9%E6%A1%88%E4%BA%8C-mybatis-plus-xml">#</a> 1.2 方案二：MyBatis Plus XML</span></a></h3><p>这个是 MyBatis Plus 拓展的使用方式，可以简化只需要写一条 SQL，步骤如下：</p><figure><img src="https://doc.iocoder.cn/img/数据库MyBatis/分页案例02/01.png" alt="分页案例 02" tabindex="0" loading="lazy"><figcaption>分页案例 02</figcaption></figure><p>① 创建 <code>AdminUserMapper.xml</code> 文件，只编写一个 SQL 查询语句：</p><div class="language- line-numbers-mode" data-ext="" data-title=""><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code" style="background-color:#282c34;--shiki-dark-bg:#282c34;color:#abb2bf;--shiki-dark:#abb2bf;" tabindex="0"><code><span class="line"><span>&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;</span></span>
<span class="line"><span>&lt;!DOCTYPE mapper PUBLIC &quot;-//mybatis.org//DTD Mapper 3.0//EN&quot; &quot;http://mybatis.org/dtd/mybatis-3-mapper.dtd&quot;&gt;</span></span>
<span class="line"><span>&lt;mapper namespace=&quot;cn.iocoder.yudao.module.system.dal.mysql.user.AdminUserMapper&quot;&gt;</span></span>
<span class="line"><span></span></span>
