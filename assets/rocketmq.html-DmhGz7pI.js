...
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-4-简单测试" tabindex="-1"><a class="header-anchor" href="#_2-4-简单测试"><span><a href="#_2-4-%E7%AE%80%E5%8D%95%E6%B5%8B%E8%AF%95">#</a> 2.4 简单测试</span></a></h3><p>〇 Run 启动 Gateway 网关服务，因为需要它来调用服务。</p><p>① Debug 启动后端项目，可以在 SmsProducer 和 SmsSendConsumer 上面打上断点，稍微调试下。</p><p>② 打开 <code>SmsTemplateController.http</code> 文件，使用 IDEA httpclient 发起请求，发送短信。如下图所示：</p><figure><img src="https://cloud.iocoder.cn/img/消息队列/内存/简单测试-cloud.png" alt="简单测试" tabindex="0" loading="lazy"><figcaption>简单测试</figcaption></figure><p>如果 IDEA 控制台看到 <code>[onMessage][消息内容</code> 日志内容，说明消息的发送和消费成功。</p>`,36)]))}const r=n(l,[["render",p],["__file","rocketmq.html.vue"]]),t=JSON.parse('{"path":"/project/yudao-cloud/message-queue/rocketmq.html","title":"消息队列（RocketMQ）","lang":"en-US","frontmatter":{"title":"消息队列（RocketMQ）","tags":["project","java","spring-boot","spring-cloud"],"categories":["project"],"order":58,"feed":false,"seo":false,"head":[]},"headers":[{"level":2,"title":"# RocketMQ-Spring","slug":"rocketmq-spring","link":"#rocketmq-spring","children":[]},{"level":2,"title":"# 2. 使用示例","slug":"_2-使用示例","link":"#_2-使用示例","children":[]},{"level":2,"title":"# 2.0 引入依赖与配置","slug":"_2-0-引入依赖与配置","link":"#_2-0-引入依赖与配置","children":[{"level":3,"title":"# 2.1 Message 消息","slug":"_2-1-message-消息","link":"#_2-1-message-消息","children":[]},{"level":3,"title":"# 2.2 SmsProducer 生产者","slug":"_2-2-smsproducer-生产者","link":"#_2-2-smsproducer-生产者","children":[]},{"level":3,"title":"# 2.3 SmsSendConsumer 消费者","slug":"_2-3-smssendconsumer-消费者","link":"#_2-3-smssendconsumer-消费者","children":[]},{"level":3,"title":"# 2.4 简单测试","slug":"_2-4-简单测试","link":"#_2-4-简单测试","children":[]}]}],"git":{"createdTime":1720365235000,"updatedTime":1720365235000,"contributors":[{"name":"Hung Nguyen Van","email":"vanhung4499@gmail.com","commits":1}]},"readingTime":{"minutes":2.98,"words":893},"filePathRelative":"project/yudao-cloud/message-queue/rocketmq.md","localizedDate":"July 7, 2024"}');export{r as comp,t as data};
