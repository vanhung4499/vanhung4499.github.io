import{_ as n,o as a,c as e,a as i}from"./app-CXKoaOJI.js";const l={};function p(r,s){return a(),e("div",null,s[0]||(s[0]=[i(`<h1 id="开发规范" tabindex="-1"><a class="header-anchor" href="#开发规范"><span>开发规范</span></a></h1><h2 id="_0-实战案例" tabindex="-1"><a class="header-anchor" href="#_0-实战案例"><span><a href="#_0-%E5%AE%9E%E6%88%98%E6%A1%88%E4%BE%8B">#</a> 0. 实战案例</span></a></h2><p>本小节，提供大家开发管理后台的功能时，最常用的普通列表、树形列表、新增与修改的表单弹窗、详情表单弹窗的实战案例。</p><h3 id="_0-1-普通列表" tabindex="-1"><a class="header-anchor" href="#_0-1-普通列表"><span><a href="#_0-1-%E6%99%AE%E9%80%9A%E5%88%97%E8%A1%A8">#</a> 0.1 普通列表</span></a></h3><p>可参考 [系统管理 -&gt; 岗位管理] 菜单：</p><ul><li>API 接口：<a href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/api/system/post/index.ts" target="_blank" rel="noopener noreferrer"><code>/src/api/system/post/index.ts</code> (opens new window)</a></li><li>列表界面：<a href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/views/system/post/index.vue" target="_blank" rel="noopener noreferrer"><code>/src/views/system/post/index.vue</code> (opens new window)</a></li><li>表单界面：<a href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/views/system/post/PostForm.vue" target="_blank" rel="noopener noreferrer"><code>/src/views/system/post/PostForm.vue</code> (opens new window)</a></li></ul><p>为什么界面拆成列表和表单两个 Vue 文件？</p><p>每个 Vue 文件，只实现一个功能，更简洁，维护性更好，Git 代码冲突概率低。</p><h3 id="_0-2-树形列表" tabindex="-1"><a class="header-anchor" href="#_0-2-树形列表"><span><a href="#_0-2-%E6%A0%91%E5%BD%A2%E5%88%97%E8%A1%A8">#</a> 0.2 树形列表</span></a></h3><p>可参考 [系统管理 -&gt; 部门管理] 菜单：</p><ul><li>API 接口：<a href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/api/system/dept/index.ts" target="_blank" rel="noopener noreferrer"><code>/src/api/system/dept/index.ts</code> (opens new window)</a></li><li>列表界面：<a href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/views/system/dept/index.vue" target="_blank" rel="noopener noreferrer"><code>/src/views/system/dept/index.vue</code> (opens new window)</a></li><li>表单界面：<a href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/views/system/dept/DeptForm.vue" target="_blank" rel="noopener noreferrer"><code>/src/views/system/dept/DeptForm.vue</code> (opens new window)</a></li></ul><h3 id="_0-3-高性能列表" tabindex="-1"><a class="header-anchor" href="#_0-3-高性能列表"><span><a href="#_0-3-%E9%AB%98%E6%80%A7%E8%83%BD%E5%88%97%E8%A1%A8">#</a> 0.3 高性能列表</span></a></h3><p>可参考 [系统管理 -&gt; 地区管理] 菜单，对应 <a href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/views/system/area/index.vue" target="_blank" rel="noopener noreferrer"><code>/src/views/system/area/index.vue</code> (opens new window)</a> 列表界面</p><p>基于 <a href="https://element-plus.org/zh-CN/component/table-v2.html" target="_blank" rel="noopener noreferrer">Virtualized Table 虚拟化表格 (opens new window)</a> 实现，解决一屏里超过 1000 条数据记录时，就会出现卡顿等性能问题。</p><h3 id="_0-4-详情弹窗" tabindex="-1"><a class="header-anchor" href="#_0-4-详情弹窗"><span><a href="#_0-4-%E8%AF%A6%E6%83%85%E5%BC%B9%E7%AA%97">#</a> 0.4 详情弹窗</span></a></h3><p>可参考 [基础设施 -&gt; API 日志 -&gt; 访问日志] 菜单，对应 <a href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/views/infra/apiAccessLog/ApiAccessLogDetail.vue" target="_blank" rel="noopener noreferrer"><code>/src/views/infra/apiAccessLog/ApiAccessLogDetail.vue</code> (opens new window)</a> 详情弹窗</p><h2 id="_1-view-页面" tabindex="-1"><a class="header-anchor" href="#_1-view-页面"><span><a href="#_1-view-%E9%A1%B5%E9%9D%A2">#</a> 1. view 页面</span></a></h2><p>在 <a href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/views/" target="_blank" rel="noopener noreferrer"><code>@views</code> (opens new window)</a> 目录下，每个模块对应一个目录，它的所有功能的 <code>.vue</code> 都放在该目录里。</p><figure><img src="https://doc.iocoder.cn/img/Vue3/开发规范/01.png" alt=" 目录" tabindex="0" loading="lazy"><figcaption> 目录</figcaption></figure><p>一般来说，一个路由对应一个 <code>index.vue</code> 文件。</p><h2 id="_2-api-请求" tabindex="-1"><a class="header-anchor" href="#_2-api-请求"><span><a href="#_2-api-%E8%AF%B7%E6%B1%82">#</a> 2. api 请求</span></a></h2><p>在 <a href="https://github.com/yudaocode/yudao-ui-admin-vue3/tree/master/src/api" target="_blank" rel="noopener noreferrer"><code>@/api</code> (opens new window)</a> 目录下，每个模块对应一个 <code>index.ts</code> API 文件。</p><figure><img src="https://doc.iocoder.cn/img/Vue3/开发规范/02.png" alt=" 目录" tabindex="0" loading="lazy"><figcaption> 目录</figcaption></figure><ul><li>API 方法：会调用 <code>request</code> 方法，发起对后端 RESTful API 的调用。</li><li><code>interface</code> 类型：定义了 API 的请求参数和返回结果的类型，对应后端的 VO 类型。</li></ul><h3 id="_2-1-请求封装" tabindex="-1"><a class="header-anchor" href="#_2-1-请求封装"><span><a href="#_2-1-%E8%AF%B7%E6%B1%82%E5%B0%81%E8%A3%85">#</a> 2.1 请求封装</span></a></h3><p><a href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/config/axios/service.ts" target="_blank" rel="noopener noreferrer"><code>/src/config/axios/index.ts</code> (opens new window)</a> 基于 <a href="http://axios-js.com/zh-cn/docs/index.html" target="_blank" rel="noopener noreferrer">axios (opens new window)</a> 封装，统一处理 GET、POST 方法的请求参数、请求头，以及错误提示信息等。</p><figure><img src="https://doc.iocoder.cn/img/Vue3/开发规范/03-01.png" alt="axios/index.ts" tabindex="0" loading="lazy"><figcaption>axios/index.ts</figcaption></figure><h4 id="_2-1-1-创建-axios-实例" tabindex="-1"><a class="header-anchor" href="#_2-1-1-创建-axios-实例"><span><a href="#_2-1-1-%E5%88%9B%E5%BB%BA-axios-%E5%AE%9E%E4%BE%8B">#</a> 2.1.1 创建 axios 实例</span></a></h4><ul><li><code>baseURL</code> 基础路径</li><li><code>timeout</code> 超时时间，默认为 30000 毫秒</li></ul><p>实现代码 /src/config/axios/service.ts</p><div class="language-" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#abb2bf;--shiki-dark:#abb2bf;--shiki-light-bg:#282c34;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code"><code><span class="line"><span>import axios from &#39;axios&#39;</span></span>
...
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-2-交互流程" tabindex="-1"><a class="header-anchor" href="#_2-2-交互流程"><span><a href="#_2-2-%E4%BA%A4%E4%BA%92%E6%B5%81%E7%A8%8B">#</a> 2.2 交互流程</span></a></h3><p>一个完整的前端 UI 交互到服务端处理流程，如下图所示：</p><figure><img src="https://doc.iocoder.cn/img/Vue3/开发规范/03-02.png" alt="交互流程" tabindex="0" loading="lazy"><figcaption>交互流程</figcaption></figure><p>继续以 [系统管理 -&gt; 岗位管理] 菜单为例，查看它是如何读取岗位列表的。代码如下：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#abb2bf;--shiki-dark:#abb2bf;--shiki-light-bg:#282c34;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code"><code><span class="line"><span>// ① api/system/post/index.ts</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>&lt;/script&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-component-组件" tabindex="-1"><a class="header-anchor" href="#_3-component-组件"><span><a href="#_3-component-%E7%BB%84%E4%BB%B6">#</a> 3. component 组件</span></a></h2><h3 id="_3-1-全局组件" tabindex="-1"><a class="header-anchor" href="#_3-1-全局组件"><span><a href="#_3-1-%E5%85%A8%E5%B1%80%E7%BB%84%E4%BB%B6">#</a> 3.1 全局组件</span></a></h3><p>在 <a href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/components/" target="_blank" rel="noopener noreferrer"><code>@/components</code> (opens new window)</a> 目录下，实现<strong>全局</strong>组件，被所有模块所公用。</p><p>例如说，富文本编辑器、各种各搜索组件、封装的分页组件等等。</p><figure><img src="https://doc.iocoder.cn/img/Vue3/开发规范/04.png" alt="全局组件" tabindex="0" loading="lazy"><figcaption>全局组件</figcaption></figure><h3 id="_3-2-模块内组件" tabindex="-1"><a class="header-anchor" href="#_3-2-模块内组件"><span><a href="#_3-2-%E6%A8%A1%E5%9D%97%E5%86%85%E7%BB%84%E4%BB%B6">#</a> 3.2 模块内组件</span></a></h3><p>每个模块的业务组件，可实现在 <code>views</code> 目录下，自己模块的目录的 <code>components</code> 目录下，避免单个 <code>.vue</code> 文件过大，降低维护成功。</p><p>例如说，<code>@/views/pay/app/components/xxx.vue</code>：</p><figure><img src="https://doc.iocoder.cn/img/Vue3/开发规范/05.png" alt="业务组件" tabindex="0" loading="lazy"><figcaption>业务组件</figcaption></figure><h2 id="_4-style-样式" tabindex="-1"><a class="header-anchor" href="#_4-style-样式"><span><a href="#_4-style-%E6%A0%B7%E5%BC%8F">#</a> 4. style 样式</span></a></h2><p>① 在 <a href="https://github.com/yudaocode/yudao-ui-admin-vue3/tree/master/src/styles" target="_blank" rel="noopener noreferrer"><code>@/styles</code> (opens new window)</a> 目录下，实现<strong>全局</strong>样式，被所有页面所公用。</p><figure><img src="https://doc.iocoder.cn/img/Vue3/开发规范/06.png" alt="全局样式" tabindex="0" loading="lazy"><figcaption>全局样式</figcaption></figure><p>② 每个 <code>.vue</code> 页面，可在 <code>&lt;style /&gt;</code> 标签中添加样式，注意需要添加 <code>scoped</code> 表示只作用在当前页面里，避免造成全局的样式污染。</p><figure><img src="https://doc.iocoder.cn/img/Vue3/开发规范/07.png" alt="业务样式" tabindex="0" loading="lazy"><figcaption>业务样式</figcaption></figure><p>更多也可以看看如下两篇文档：</p><ul><li><a href="https://element-plus-admin-doc.cn/guide/settings.html#%E6%A0%B7%E5%BC%8F%E9%85%8D%E7%BD%AE" target="_blank" rel="noopener noreferrer">《vue-element-plus-admin —— 项目配置「样式配置」》 (opens new window)</a></li><li><a href="https://element-plus-admin-doc.cn/guide/design.html" target="_blank" rel="noopener noreferrer">《vue-element-plus-admin —— 样式》 (opens new window)</a></li></ul><h2 id="_5-项目规范" tabindex="-1"><a class="header-anchor" href="#_5-项目规范"><span><a href="#_5-%E9%A1%B9%E7%9B%AE%E8%A7%84%E8%8C%83">#</a> 5. 项目规范</span></a></h2><p>可参考 <a href="https://element-plus-admin-doc.cn/dep/lint.html" target="_blank" rel="noopener noreferrer">《vue-element-plus-admin —— 项目规范》 (opens new window)</a> 文档。</p>`,62)]))}const d=n(l,[["render",p],["__file","181-dev-spec.html.vue"]]),t=JSON.parse('{"path":"/project/rouyi-vue-pro/vue3/181-dev-spec.html","title":"开发规范","lang":"en-US","frontmatter":{"title":"开发规范","tags":["project","java","spring-boot","spring-cloud"],"categories":["project"],"order":183,"feed":false,"seo":false,"head":[]},"headers":[{"level":2,"title":"# 0. 实战案例","slug":"_0-实战案例","link":"#_0-实战案例","children":[{"level":3,"title":"# 0.1 普通列表","slug":"_0-1-普通列表","link":"#_0-1-普通列表","children":[]},{"level":3,"title":"# 0.2 树形列表","slug":"_0-2-树形列表","link":"#_0-2-树形列表","children":[]},{"level":3,"title":"# 0.3 高性能列表","slug":"_0-3-高性能列表","link":"#_0-3-高性能列表","children":[]},{"level":3,"title":"# 0.4 详情弹窗","slug":"_0-4-详情弹窗","link":"#_0-4-详情弹窗","children":[]}]},{"level":2,"title":"# 1. view 页面","slug":"_1-view-页面","link":"#_1-view-页面","children":[]},{"level":2,"title":"# 2. api 请求","slug":"_2-api-请求","link":"#_2-api-请求","children":[{"level":3,"title":"# 2.1 请求封装","slug":"_2-1-请求封装","link":"#_2-1-请求封装","children":[]},{"level":3,"title":"# 2.2 交互流程","slug":"_2-2-交互流程","link":"#_2-2-交互流程","children":[]}]},{"level":2,"title":"# 3. component 组件","slug":"_3-component-组件","link":"#_3-component-组件","children":[{"level":3,"title":"# 3.1 全局组件","slug":"_3-1-全局组件","link":"#_3-1-全局组件","children":[]},{"level":3,"title":"# 3.2 模块内组件","slug":"_3-2-模块内组件","link":"#_3-2-模块内组件","children":[]}]},{"level":2,"title":"# 4. style 样式","slug":"_4-style-样式","link":"#_4-style-样式","children":[]},{"level":2,"title":"# 5. 项目规范","slug":"_5-项目规范","link":"#_5-项目规范","children":[]}],"git":{"createdTime":1736653285000,"updatedTime":1736653285000,"contributors":[{"name":"Hung Nguyen","email":"vanhung4499@gmail.com","commits":1}]},"readingTime":{"minutes":7.58,"words":2274},"filePathRelative":"project/rouyi-vue-pro/vue3/181-dev-spec.md","localizedDate":"January 12, 2025"}');export{d as comp,t as data};
