...
<span class="line"><span>    }</span></span>
<span class="line"><span>  ]</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="_2-路由" tabindex="-1"><a class="header-anchor" href="#_2-路由"><span><a href="#_2-%E8%B7%AF%E7%94%B1">#</a> 2. 路由</span></a></h2><p>项目的路由分为两种：静态路由、动态路由。</p><h3 id="_2-1-静态路由" tabindex="-1"><a class="header-anchor" href="#_2-1-静态路由"><span><a href="#_2-1-%E9%9D%99%E6%80%81%E8%B7%AF%E7%94%B1">#</a> 2.1 静态路由</span></a></h3><p>静态路由，代表那些不需要动态判断权限的路由，如登录页、404、个人中心等通用页面。</p><p>在 <a href="https://github.com/yudaocode/yudao-ui-admin-vue3/tree/master/src/router/modules/remaining.ts" target="_blank" rel="noopener noreferrer">@/router/modules/remaining.ts (opens new window)</a> 的 <code>remainingRouter</code>，就是配置对应的公共路由。如下图所示：</p><figure><img src="https://doc.iocoder.cn/img/Vue3/菜单路由/01.png" alt="静态路由" tabindex="0" loading="lazy"><figcaption>静态路由</figcaption></figure><h3 id="_2-2-动态路由" tabindex="-1"><a class="header-anchor" href="#_2-2-动态路由"><span><a href="#_2-2-%E5%8A%A8%E6%80%81%E8%B7%AF%E7%94%B1">#</a> 2.2 动态路由</span></a></h3><p>动态路由，代表那些需要根据用户动态判断权限，并通过 <a href="https://router.vuejs.org/guide/advanced/dynamic-routing.html#adding-routes" target="_blank" rel="noopener noreferrer">addRoutes (opens new window)</a> 动态添加的页面，如用户管理、角色管理等功能页面。</p><p>在用户登录成功后，会触发 <a href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/store/modules/permission.ts#L35-L66" target="_blank" rel="noopener noreferrer"><code>@/store/modules/permission.ts</code> (opens new window)</a> 请求后端的菜单 RESTful API 接口，获取用户<strong>有权限</strong>的菜单列表，并转化添加到路由中。如下图所示：</p><figure><img src="https://doc.iocoder.cn/img/Vue3/菜单路由/02.png" alt="动态路由" tabindex="0" loading="lazy"><figcaption>动态路由</figcaption></figure><p>友情提示：</p><ol><li>动态路由可以在 [系统管理 -&gt; 菜单管理] 进行新增和修改操作，请求的后端 RESTful API 接口是 <a href="https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-module-system/yudao-module-system-biz/src/main/java/cn/iocoder/yudao/module/system/controller/admin/auth/AuthController.java#L107-L110" target="_blank" rel="noopener noreferrer"><code>/admin-api/system/auth/get-permission-info</code> (opens new window)</a></li><li>动态路由在生产环境下会默认使用路由懒加载，实现方式参考 <a href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/utils/routerHelper.ts#L6" target="_blank" rel="noopener noreferrer">import.meta.glob(&#39;../views/**/*.{vue,tsx}&#39;) (opens new window)</a> 方法的判断<br> 补充说明：</li></ol><p>最新的代码，部分逻辑重构到 <a href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/permission.ts#L44-L48" target="_blank" rel="noopener noreferrer"><code>@/permission.ts</code> (opens new window)</a></p><h3 id="_2-3-路由跳转" tabindex="-1"><a class="header-anchor" href="#_2-3-路由跳转"><span><a href="#_2-3-%E8%B7%AF%E7%94%B1%E8%B7%B3%E8%BD%AC">#</a> 2.3 路由跳转</span></a></h3><p>使用 <code>router.push</code> 方法，可以实现跳转到不同的页面。</p><div class="language-" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#abb2bf;--shiki-dark:#abb2bf;--shiki-light-bg:#282c34;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code"><code><span class="line"><span>const { push } = useRouter()</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>push(&#39;/bpm/process-instance/detail?id=&#39; + row.processInstance.id)</span></span></code></pre></div><h2 id="_3-菜单管理" tabindex="-1"><a class="header-anchor" href="#_3-菜单管理"><span><a href="#_3-%E8%8F%9C%E5%8D%95%E7%AE%A1%E7%90%86">#</a> 3. 菜单管理</span></a></h2><p>项目的菜单在 [系统管理 -&gt; 菜单管理] 进行管理，支持<strong>无限</strong>层级，提供目录、菜单、按钮三种类型。如下图所示：</p><figure><img src="https://doc.iocoder.cn/img/Vue3/菜单路由/03.png" alt="系统管理 -&gt; 菜单管理" tabindex="0" loading="lazy"><figcaption>系统管理 -&gt; 菜单管理</figcaption></figure><p>菜单可在 [系统管理 -&gt; 角色管理] 被分配给角色。如下图所示：</p><figure><img src="https://doc.iocoder.cn/img/Vue3/菜单路由/04.png" alt="系统管理 -&gt; 角色管理" tabindex="0" loading="lazy"><figcaption>系统管理 -&gt; 角色管理</figcaption></figure><h3 id="_3-1-新增目录" tabindex="-1"><a class="header-anchor" href="#_3-1-新增目录"><span><a href="#_3-1-%E6%96%B0%E5%A2%9E%E7%9B%AE%E5%BD%95">#</a> 3.1 新增目录</span></a></h3><p>① 大多数情况下，目录是作为菜单的【分类】：</p><figure><img src="https://doc.iocoder.cn/img/Vue3/菜单路由/05.png" alt="新增目录 —— 菜单的分类" tabindex="0" loading="lazy"><figcaption>新增目录 —— 菜单的分类</figcaption></figure><p>② 目录也提供实现【外链】的能力：</p><figure><img src="https://doc.iocoder.cn/img/Vue3/菜单路由/06.png" alt="新增目录 —— 外链" tabindex="0" loading="lazy"><figcaption>新增目录 —— 外链</figcaption></figure><h3 id="_3-2-新增菜单" tabindex="-1"><a class="header-anchor" href="#_3-2-新增菜单"><span><a href="#_3-2-%E6%96%B0%E5%A2%9E%E8%8F%9C%E5%8D%95">#</a> 3.2 新增菜单</span></a></h3><figure><img src="https://doc.iocoder.cn/img/Vue3/菜单路由/07.png" alt="新增菜单" tabindex="0" loading="lazy"><figcaption>新增菜单</figcaption></figure><h3 id="_3-3-新增按钮" tabindex="-1"><a class="header-anchor" href="#_3-3-新增按钮"><span><a href="#_3-3-%E6%96%B0%E5%A2%9E%E6%8C%89%E9%92%AE">#</a> 3.3 新增按钮</span></a></h3><figure><img src="https://doc.iocoder.cn/img/Vue3/菜单路由/08.png" alt="新增按钮" tabindex="0" loading="lazy"><figcaption>新增按钮</figcaption></figure><h2 id="_4-权限控制" tabindex="-1"><a class="header-anchor" href="#_4-权限控制"><span><a href="#_4-%E6%9D%83%E9%99%90%E6%8E%A7%E5%88%B6">#</a> 4. 权限控制</span></a></h2><p>前端通过权限控制，隐藏用户没有权限的按钮等，实现功能级别的权限。</p><p>友情提示：前端的权限控制，主要是提升用户体验，避免操作后发现没有权限。</p><p>最终在请求到后端时，还是会进行一次权限的校验。</p><h3 id="_4-1-v-haspermi-指令" tabindex="-1"><a class="header-anchor" href="#_4-1-v-haspermi-指令"><span><a href="#_4-1-v-haspermi-%E6%8C%87%E4%BB%A4">#</a> 4.1 v-hasPermi 指令</span></a></h3><p><a href="https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/directives/permission/hasPermi.ts" target="_blank" rel="noopener noreferrer"><code>v-hasPermi</code> (opens new window)</a> 指令，基于权限字符，进行权限的控制。</p><div class="language-" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#abb2bf;--shiki-dark:#abb2bf;--shiki-light-bg:#282c34;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code"><code><span class="line"><span>&lt;!-- 单个 --&gt;</span></span>
