import{_ as a,o as s,c as e,a as l}from"./app-CXKoaOJI.js";const i={};function p(t,n){return s(),e("div",null,n[0]||(n[0]=[l(`<h1 id="分页实现" tabindex="-1"><a class="header-anchor" href="#分页实现"><span>分页实现</span></a></h1><ul><li>前端：基于 Element UI 分页组件 <a href="https://element.eleme.io/#/zh-CN/component/pagination" target="_blank" rel="noopener noreferrer">Pagination (opens new window)</a></li><li>后端：基于 MyBatis Plus 分页功能，二次封装</li></ul><p>以 [系统管理 -&gt; 租户管理 -&gt; 租户列表] 菜单为例子，讲解它的分页 + 搜索的实现。</p><h2 id="_1-前端分页实现" tabindex="-1"><a class="header-anchor" href="#_1-前端分页实现"><span><a href="#_1-%E5%89%8D%E7%AB%AF%E5%88%86%E9%A1%B5%E5%AE%9E%E7%8E%B0">#</a> 1. 前端分页实现</span></a></h2><h3 id="_1-1-vue-界面" tabindex="-1"><a class="header-anchor" href="#_1-1-vue-界面"><span><a href="#_1-1-vue-%E7%95%8C%E9%9D%A2">#</a> 1.1 Vue 界面</span></a></h3><p>界面 <a href="https://github.com/yudaocode/yudao-ui-admin-vue2/blob/master/src/views/system/tenant/index.vue" target="_blank" rel="noopener noreferrer"><code>tenant/index.vue</code> (opens new window)</a> 相关的代码如下：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#abb2bf;--shiki-dark:#abb2bf;--shiki-light-bg:#282c34;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code"><code><span class="line"><span>&lt;template&gt;</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>&lt;/script&gt;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-2-api-请求" tabindex="-1"><a class="header-anchor" href="#_1-2-api-请求"><span><a href="#_1-2-api-%E8%AF%B7%E6%B1%82">#</a> 1.2 API 请求</span></a></h3><p>请求 <a href="https://github.com/yudaocode/yudao-ui-admin-vue2/blob/master/src/api/system/tenant.js" target="_blank" rel="noopener noreferrer"><code>system/tenant.js</code> (opens new window)</a> 相关的代码如下：</p><div class="language-" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#abb2bf;--shiki-dark:#abb2bf;--shiki-light-bg:#282c34;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code"><code><span class="line"><span>import request from &#39;@/utils/request&#39;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  })</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="_2-后端分页实现" tabindex="-1"><a class="header-anchor" href="#_2-后端分页实现"><span><a href="#_2-%E5%90%8E%E7%AB%AF%E5%88%86%E9%A1%B5%E5%AE%9E%E7%8E%B0">#</a> 2. 后端分页实现</span></a></h2><h3 id="_2-1-controller-接口" tabindex="-1"><a class="header-anchor" href="#_2-1-controller-接口"><span><a href="#_2-1-controller-%E6%8E%A5%E5%8F%A3">#</a> 2.1 Controller 接口</span></a></h3><p>在 <a href="https://github.com/YunaiV/yudao-cloud/blob/master/yudao-module-system/yudao-module-system-biz/src/main/java/cn/iocoder/yudao/module/system/controller/admin/tenant/TenantController.java#L75-L81" target="_blank" rel="noopener noreferrer">TenantController (opens new window)</a> 类中，定义 <code>/admin-api/system/tenant/page</code> 接口。代码如下：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#abb2bf;--shiki-dark:#abb2bf;--shiki-light-bg:#282c34;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code"><code><span class="line"><span>@Tag(name = &quot;管理后台 - 租户&quot;)</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>分页条件，在子类中进行定义。以 TenantPageReqVO 举例子，代码如下：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#abb2bf;--shiki-dark:#abb2bf;--shiki-light-bg:#282c34;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code"><code><span class="line"><span>@Schema(description = &quot;管理后台 - 租户分页 Request VO&quot;)</span></span>
<span class="line"><span>@Data</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-1-2-分页结果-pageresult" tabindex="-1"><a class="header-anchor" href="#_2-1-2-分页结果-pageresult"><span><a href="#_2-1-2-%E5%88%86%E9%A1%B5%E7%BB%93%E6%9E%9C-pageresult">#</a> 2.1.2 分页结果 PageResult</span></a></h4><p>分页结果 <a href="https://github.com/YunaiV/yudao-cloud/blob/master/yudao-framework/yudao-common/src/main/java/cn/iocoder/yudao/framework/common/pojo/PageResult.java" target="_blank" rel="noopener noreferrer">PageResult (opens new window)</a> 类，代码如下：</p><div class="language-" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#abb2bf;--shiki-dark:#abb2bf;--shiki-light-bg:#282c34;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code"><code><span class="line"><span>@Schema(description = &quot;分页结果&quot;)</span></span>
<span class="line"><span>@Data</span></span>
...
<span class="line"><span>    </span></span>
<span class="line"><span>}</span></span></code></pre></div><p>分页结果的数据 <code>list</code> 的每一项，通过自定义 VO 类，例如说 <a href="https://github.com/YunaiV/yudao-cloud/blob/master/yudao-module-system/yudao-module-system-biz/src/main/java/cn/iocoder/yudao/module/system/controller/admin/tenant/vo/tenant/TenantRespVO.java" target="_blank" rel="noopener noreferrer">TenantRespVO (opens new window)</a> 类。</p><h3 id="_2-2-mapper-查询" tabindex="-1"><a class="header-anchor" href="#_2-2-mapper-查询"><span><a href="#_2-2-mapper-%E6%9F%A5%E8%AF%A2">#</a> 2.2 Mapper 查询</span></a></h3><p>在 <a href="https://github.com/YunaiV/yudao-cloud/blob/master/yudao-module-system/yudao-module-system-biz/src/main/java/cn/iocoder/yudao/module/system/dal/mysql/tenant/TenantMapper.java" target="_blank" rel="noopener noreferrer">TenantMapper (opens new window)</a> 类中，定义 selectPage 查询方法。代码如下：</p><div class="language-" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#abb2bf;--shiki-dark:#abb2bf;--shiki-light-bg:#282c34;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code"><code><span class="line"><span>@Mapper</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>    </span></span>
<span class="line"><span>}</span></span></code></pre></div><p>针对 MyBatis Plus 分页查询的二次分装，在 <a href="https://github.com/YunaiV/yudao-cloud/blob/master/yudao-framework/yudao-spring-boot-starter-mybatis/src/main/java/cn/iocoder/yudao/framework/mybatis/core/mapper/BaseMapperX.java" target="_blank" rel="noopener noreferrer">BaseMapperX (opens new window)</a> 中实现，主要是将 MyBatis 的分页结果 IPage，转换成项目的分页结果 PageResult。代码如下图：</p><figure><img src="https://cloud.iocoder.cn/img/分页实现/01.png" alt="BaseMapperX 实现" tabindex="0" loading="lazy"><figcaption>BaseMapperX 实现</figcaption></figure>`,29)]))}const c=a(i,[["render",p],["__file","37-page-feature.html.vue"]]),d=JSON.parse('{"path":"/project/yudao-cloud/37-page-feature.html","title":"分页实现","lang":"en-US","frontmatter":{"title":"分页实现","tags":["project","java","spring-boot","spring-cloud"],"categories":["project"],"order":39,"feed":false,"seo":false,"head":[]},"headers":[{"level":2,"title":"# 1. 前端分页实现","slug":"_1-前端分页实现","link":"#_1-前端分页实现","children":[{"level":3,"title":"# 1.1 Vue 界面","slug":"_1-1-vue-界面","link":"#_1-1-vue-界面","children":[]},{"level":3,"title":"# 1.2 API 请求","slug":"_1-2-api-请求","link":"#_1-2-api-请求","children":[]}]},{"level":2,"title":"# 2. 后端分页实现","slug":"_2-后端分页实现","link":"#_2-后端分页实现","children":[{"level":3,"title":"# 2.1 Controller 接口","slug":"_2-1-controller-接口","link":"#_2-1-controller-接口","children":[]},{"level":3,"title":"# 2.2 Mapper 查询","slug":"_2-2-mapper-查询","link":"#_2-2-mapper-查询","children":[]}]}],"git":{"createdTime":1736653285000,"updatedTime":1736653285000,"contributors":[{"name":"Hung Nguyen","email":"vanhung4499@gmail.com","commits":1}]},"readingTime":{"minutes":4.08,"words":1225},"filePathRelative":"project/yudao-cloud/37-page-feature.md","localizedDate":"January 12, 2025"}');export{c as comp,d as data};
