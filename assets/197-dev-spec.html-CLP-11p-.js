import{_ as n,o as a,c as e,a as i}from"./app-CXKoaOJI.js";const l={};function p(r,s){return a(),e("div",null,s[0]||(s[0]=[i(`<h1 id="开发规范" tabindex="-1"><a class="header-anchor" href="#开发规范"><span>开发规范</span></a></h1><h2 id="_1-view-页面" tabindex="-1"><a class="header-anchor" href="#_1-view-页面"><span><a href="#_1-view-%E9%A1%B5%E9%9D%A2">#</a> 1. view 页面</span></a></h2><p>在 <a href="https://github.com/yudaocode/yudao-ui-admin-vue2/tree/master/src/views" target="_blank" rel="noopener noreferrer"><code>@views</code> (opens new window)</a> 目录下，每个模块对应一个目录，它的所有功能的 <code>.vue</code> 都放在该目录里。</p><figure><img src="https://cloud.iocoder.cn/img/Vue2/开发规范/01.png" alt=" 目录" tabindex="0" loading="lazy"><figcaption> 目录</figcaption></figure><p>一般来说，一个路由对应一个 <code>.vue</code> 文件。</p><h2 id="_2-api-请求" tabindex="-1"><a class="header-anchor" href="#_2-api-请求"><span><a href="#_2-api-%E8%AF%B7%E6%B1%82">#</a> 2. api 请求</span></a></h2><p>在 <a href="https://github.com/yudaocode/yudao-ui-admin-vue2/tree/master/src/api" target="_blank" rel="noopener noreferrer"><code>@/api</code> (opens new window)</a> 目录下，每个模块对应一个 <code>.api</code> 文件。</p><figure><img src="https://cloud.iocoder.cn/img/Vue2/开发规范/02.png" alt=" 目录" tabindex="0" loading="lazy"><figcaption> 目录</figcaption></figure><p>每个 API 方法，会调用 <code>request</code> 方法，发起对后端 RESTful API 的调用。</p><h3 id="_2-1-请求封装" tabindex="-1"><a class="header-anchor" href="#_2-1-请求封装"><span><a href="#_2-1-%E8%AF%B7%E6%B1%82%E5%B0%81%E8%A3%85">#</a> 2.1 请求封装</span></a></h3><p><a href="https://github.com/yudaocode/yudao-ui-admin-vue2/blob/master/src/utils/request.js" target="_blank" rel="noopener noreferrer"><code>@/utils/request</code> (opens new window)</a> 基于 <a href="http://axios-js.com/zh-cn/docs/index.html" target="_blank" rel="noopener noreferrer">axios (opens new window)</a> 封装，统一处理 GET、POST 方法的请求参数、请求头，以及错误提示信息等。</p><h4 id="_2-1-1-创建-axios-实例" tabindex="-1"><a class="header-anchor" href="#_2-1-1-创建-axios-实例"><span><a href="#_2-1-1-%E5%88%9B%E5%BB%BA-axios-%E5%AE%9E%E4%BE%8B">#</a> 2.1.1 创建 axios 实例</span></a></h4><ul><li><code>baseURL</code> 基础路径</li><li><code>timeout</code> 超时时间</li></ul><p>实现代码</p><div class="language-" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#abb2bf;--shiki-dark:#abb2bf;--shiki-light-bg:#282c34;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code"><code><span class="line"><span>import axios from &#39;axios&#39;</span></span>
...
<span class="line"><span>    })</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="_3-component-组件" tabindex="-1"><a class="header-anchor" href="#_3-component-组件"><span><a href="#_3-component-%E7%BB%84%E4%BB%B6">#</a> 3. component 组件</span></a></h2><p>① 在 <a href="https://github.com/yudaocode/yudao-ui-admin-vue2/tree/master/src/components" target="_blank" rel="noopener noreferrer"><code>@/components</code> (opens new window)</a> 目录下，实现<strong>全局</strong>组件，被所有模块所公用。例如说，富文本编辑器、各种各搜索组件、封装的分页组件等等。</p><figure><img src="https://cloud.iocoder.cn/img/Vue2/开发规范/04.png" alt="全局组件" tabindex="0" loading="lazy"><figcaption>全局组件</figcaption></figure><p>② 每个模块的业务组件，可实现在 <code>views</code> 目录下，自己模块的目录的 <code>components</code> 目录下，避免单个 <code>.vue</code> 文件过大，降低维护成功。例如说，<code>@/views/pay/app/components/xxx.vue</code>。</p><figure><img src="https://cloud.iocoder.cn/img/Vue2/开发规范/05.png" alt="业务组件" tabindex="0" loading="lazy"><figcaption>业务组件</figcaption></figure><h2 id="_4-style-样式" tabindex="-1"><a class="header-anchor" href="#_4-style-样式"><span><a href="#_4-style-%E6%A0%B7%E5%BC%8F">#</a> 4. style 样式</span></a></h2><p>① 在 <a href="https://github.com/yudaocode/yudao-ui-admin-vue2/tree/master/src/styles" target="_blank" rel="noopener noreferrer"><code>@/styles</code> (opens new window)</a> 目录下，实现<strong>全局</strong>样式，被所有页面所公用。</p><figure><img src="https://cloud.iocoder.cn/img/Vue2/开发规范/06.png" alt="全局样式" tabindex="0" loading="lazy"><figcaption>全局样式</figcaption></figure><p>② 每个 <code>.vue</code> 页面，可在 <code>&lt;style /&gt;</code> 标签中添加样式，注意需要添加 <code>scoped</code> 表示只作用在当前页面里，避免造成全局的样式污染。</p><figure><img src="https://cloud.iocoder.cn/img/Vue2/开发规范/07.png" alt="业务样式" tabindex="0" loading="lazy"><figcaption>业务样式</figcaption></figure>`,41)]))}const d=n(l,[["render",p],["__file","197-dev-spec.html.vue"]]),o=JSON.parse('{"path":"/project/yudao-cloud/vue2/197-dev-spec.html","title":"开发规范","lang":"en-US","frontmatter":{"title":"开发规范","tags":["project","java","spring-boot","spring-cloud"],"categories":["project"],"order":199,"feed":false,"seo":false,"head":[]},"headers":[{"level":2,"title":"# 1. view 页面","slug":"_1-view-页面","link":"#_1-view-页面","children":[]},{"level":2,"title":"# 2. api 请求","slug":"_2-api-请求","link":"#_2-api-请求","children":[{"level":3,"title":"# 2.1 请求封装","slug":"_2-1-请求封装","link":"#_2-1-请求封装","children":[]},{"level":3,"title":"# 2.2 交互流程","slug":"_2-2-交互流程","link":"#_2-2-交互流程","children":[]},{"level":3,"title":"# 2.3 自定义 baseURL 基础路径","slug":"_2-3-自定义-baseurl-基础路径","link":"#_2-3-自定义-baseurl-基础路径","children":[]}]},{"level":2,"title":"# 3. component 组件","slug":"_3-component-组件","link":"#_3-component-组件","children":[]},{"level":2,"title":"# 4. style 样式","slug":"_4-style-样式","link":"#_4-style-样式","children":[]}],"git":{"createdTime":1736653285000,"updatedTime":1736653285000,"contributors":[{"name":"Hung Nguyen","email":"vanhung4499@gmail.com","commits":1}]},"readingTime":{"minutes":4.06,"words":1219},"filePathRelative":"project/yudao-cloud/vue2/197-dev-spec.md","localizedDate":"January 12, 2025"}');export{d as comp,o as data};
