...
<span class="line"><span>}</span></span></code></pre></div><h4 id="_2-2-3-调用-api" tabindex="-1"><a class="header-anchor" href="#_2-2-3-调用-api"><span><a href="#_2-2-3-%E8%B0%83%E7%94%A8-api">#</a> 2.2.3 调用 API</span></a></h4><p>例如说，<a href="https://github.com/YunaiV/yudao-cloud/blob/master/yudao-module-bpm/yudao-module-bpm-biz/src/main/java/cn/iocoder/yudao/module/bpm/service/task/BpmTaskServiceImpl.java#L302" target="_blank" rel="noopener noreferrer">BpmTaskServiceImpl</a> 调用了 AdminUserApi 接口，代码如下：</p><div class="language-" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#abb2bf;--shiki-dark:#abb2bf;--shiki-light-bg:#282c34;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code"><code><span class="line"><span>@Service</span></span>
