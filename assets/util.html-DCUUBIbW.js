...
<span class="line"><span>this.$download.markdown(data, fileName);</span></span></code></pre></div><p>在 <a href="https://github.com/yudaocode/yudao-ui-admin-vue2/blob/master/src/views/system/user/index.vue#L581-L594" target="_blank" rel="noopener noreferrer"><code>user/index.vue</code></a> 页面中，导出 Excel 文件的代码如下图：</p><figure><img src="https://cloud.iocoder.cn/img/Vue2/通用方法/01.png" alt="导出 Excel 文件" tabindex="0" loading="lazy"><figcaption>导出 Excel 文件</figcaption></figure>`,53),l=[o];function t(i,c){return s(),n("div",null,l)}const r=a(p,[["render",t],["__file","util.html.vue"]]),h=JSON.parse('{"path":"/project/yudao-cloud/vue2/util.html","title":"通用方法","lang":"en-US","frontmatter":{"title":"通用方法","tags":["project","java","spring-boot","spring-cloud"],"categories":["project"],"order":170,"feed":false,"seo":false,"head":[]},"headers":[{"level":2,"title":"# 1. $tab 对象","slug":"_1-tab-对象","link":"#_1-tab-对象","children":[]},{"level":2,"title":"# 2. $modal 对象","slug":"_2-modal-对象","link":"#_2-modal-对象","children":[]},{"level":2,"title":"# 3. $auth 对象","slug":"_3-auth-对象","link":"#_3-auth-对象","children":[]},{"level":2,"title":"# 4. $cache 对象","slug":"_4-cache-对象","link":"#_4-cache-对象","children":[]},{"level":2,"title":"# 5. $download 对象","slug":"_5-download-对象","link":"#_5-download-对象","children":[]}],"git":{"createdTime":1720365235000,"updatedTime":1720365235000,"contributors":[{"name":"Hung Nguyen Van","email":"vanhung4499@gmail.com","commits":1}]},"readingTime":{"minutes":3.4,"words":1021},"filePathRelative":"project/yudao-cloud/vue2/util.md","localizedDate":"July 7, 2024"}');export{r as comp,h as data};
