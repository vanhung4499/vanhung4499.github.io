import{_ as n,o as a,c as e,a as i}from"./app-CXKoaOJI.js";const p={};function l(d,s){return a(),e("div",null,s[0]||(s[0]=[i(`<h1 id="消息队列-rocketmq" tabindex="-1"><a class="header-anchor" href="#消息队列-rocketmq"><span>消息队列（RocketMQ）</span></a></h1><h2 id="rocketmq-spring" tabindex="-1"><a class="header-anchor" href="#rocketmq-spring"><span><a href="#rocketmq-spring">#</a> RocketMQ-Spring</span></a></h2><p><a href="https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-framework/yudao-spring-boot-starter-mq/" target="_blank" rel="noopener noreferrer"><code>yudao-spring-boot-starter-mq</code> (opens new window)</a> 技术组件，基于 RocketMQ 实现分布式消息队列。</p><p>如果你对 RocketMQ 不太了解，可以看看 <a href="https://www.iocoder.cn/Spring-Boot/RocketMQ/?yudao" target="_blank" rel="noopener noreferrer">《芋道 Spring Boot 消息队列 RocketMQ 入门》 (opens new window)</a> 文档。</p><p>如何安装一个 RocketMQ 服务？</p><p>参考 <a href="https://www.iocoder.cn/RocketMQ/install/?yudao" target="_blank" rel="noopener noreferrer">《芋道 RocketMQ 极简入门 》 (opens new window)</a> 文档。</p><h2 id="_2-使用示例" tabindex="-1"><a class="header-anchor" href="#_2-使用示例"><span><a href="#_2-%E4%BD%BF%E7%94%A8%E7%A4%BA%E4%BE%8B">#</a> 2. 使用示例</span></a></h2><p>以【短信发送】举例子，改造使用 RocketMQ 作为消息队列。</p><h2 id="_2-0-引入依赖与配置" tabindex="-1"><a class="header-anchor" href="#_2-0-引入依赖与配置"><span><a href="#_2-0-%E5%BC%95%E5%85%A5%E4%BE%9D%E8%B5%96%E4%B8%8E%E9%85%8D%E7%BD%AE">#</a> 2.0 引入依赖与配置</span></a></h2><p>① 在 <code>yudao-module-system-biz</code> 模块中，引入 <code>yudao-spring-boot-starter-mq</code> 技术组件。如下所示：</p><div class="language-" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#abb2bf;--shiki-dark:#abb2bf;--shiki-light-bg:#282c34;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code"><code><span class="line"><span>&lt;dependency&gt;</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-4-简单测试" tabindex="-1"><a class="header-anchor" href="#_2-4-简单测试"><span><a href="#_2-4-%E7%AE%80%E5%8D%95%E6%B5%8B%E8%AF%95">#</a> 2.4 简单测试</span></a></h3><p>① Debug 启动后端项目，可以在 SmsProducer 和 SmsSendConsumer 上面打上断点，稍微调试下。</p><p>② 打开 <code>SmsTemplateController.http</code> 文件，使用 IDEA httpclient 发起请求，发送短信。如下图所示：</p><figure><img src="https://doc.iocoder.cn/img/消息队列/内存/简单测试.png" alt="简单测试" tabindex="0" loading="lazy"><figcaption>简单测试</figcaption></figure><p>如果 IDEA 控制台看到 <code>[onMessage][消息内容</code> 日志内容，说明消息的发送和消费成功。</p>`,34)]))}const c=n(p,[["render",l],["__file","61-rocketmq.html.vue"]]),t=JSON.parse('{"path":"/project/rouyi-vue-pro/message-queue/61-rocketmq.html","title":"消息队列（RocketMQ）","lang":"en-US","frontmatter":{"title":"消息队列（RocketMQ）","tags":["project","java","spring-boot","spring-cloud"],"categories":["project"],"order":63,"feed":false,"seo":false,"head":[]},"headers":[{"level":2,"title":"# RocketMQ-Spring","slug":"rocketmq-spring","link":"#rocketmq-spring","children":[]},{"level":2,"title":"# 2. 使用示例","slug":"_2-使用示例","link":"#_2-使用示例","children":[]},{"level":2,"title":"# 2.0 引入依赖与配置","slug":"_2-0-引入依赖与配置","link":"#_2-0-引入依赖与配置","children":[{"level":3,"title":"# 2.1 Message 消息","slug":"_2-1-message-消息","link":"#_2-1-message-消息","children":[]},{"level":3,"title":"# 2.2 SmsProducer 生产者","slug":"_2-2-smsproducer-生产者","link":"#_2-2-smsproducer-生产者","children":[]},{"level":3,"title":"# 2.3 SmsSendConsumer 消费者","slug":"_2-3-smssendconsumer-消费者","link":"#_2-3-smssendconsumer-消费者","children":[]},{"level":3,"title":"# 2.4 简单测试","slug":"_2-4-简单测试","link":"#_2-4-简单测试","children":[]}]}],"git":{"createdTime":1736653285000,"updatedTime":1736653285000,"contributors":[{"name":"Hung Nguyen","email":"vanhung4499@gmail.com","commits":1}]},"readingTime":{"minutes":2.91,"words":873},"filePathRelative":"project/rouyi-vue-pro/message-queue/61-rocketmq.md","localizedDate":"January 12, 2025"}');export{c as comp,t as data};
